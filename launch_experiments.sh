...
for i in "${!CONFIGS[@]}"; do
	...
	oarsub -t deploy -t night -p "host IN (dahu-4,dahu-5,dahu-6,dahu-7,dahu-8,dahu-9,dahu-10,dahu-11,dahu-12,dahu-13,dahu-14,dahu-15,dahu-16,dahu-17,dahu-19,dahu-20,dahu-21,dahu-22,dahu-23,dahu-24,dahu-25)" -l "walltime=01:00:00" "
        ...
        " > "/home/logs/${run_tag}_oarsub_id.log"
done
